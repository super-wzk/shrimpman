...
use egui::{
    Id, InnerResponse, Response, ScrollArea, Sense, Ui, UiBuilder, scroll_area::ScrollAreaOutput,
};
    ...
    fn show_content<R>(
        ...
        let output = self
            ...
            .show(ui, |ui| {
                ...
                let info = egui::UiStackInfo::default()
                    .with_frame(egui::Frame::new().fill(ui.stack().bg_color()));
