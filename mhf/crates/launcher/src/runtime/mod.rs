...
impl PreparedLaunch {
    ...
    #[cfg(feature = "offline")]
    pub fn launch_offline(
        self,
        profile: &MhfLaunchProfile<'_>,
        session: crate::offline::Session,
    ) -> Result<i32, String> {
        self.with_offline(profile, session, false)
    }
    ...
    pub fn launch_debug(
        ...
        self.with_offline(profile, session, true)
    }
    ...
    fn with_game(
        ...
        let _font = crate::font::register_for(&self.mhf.font.name)?;
