...
impl RuntimeLocale {
    pub(crate) fn translation(&self, key: TranslationKey) -> Option<&'static [u8]> {
...
mod tests {
    ...
    use crate::translation::TranslationKey;
    ...
    fn generated_locales_contain_only_nul_terminated_utf8_records() {
        let dictionary = &crate::translation::TRANSLATION_DICTIONARY;
