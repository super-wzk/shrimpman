...
let
  ...
  command = name: text: mkCommand { inherit name text; directory = "mhf"; };
in
{
  imports = [ ./config.nix ];
  ...
  config = {
    ...
    development.commands = {
      ...
      mhf-launcher = mkDefault (command "mhf-launcher" ''
        ...
        '' else lib.optionalString (config.development.mhf.runner != "") ''
